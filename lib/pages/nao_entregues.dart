...
class Pedidos_nao_Entregues extends StatefulWidget {
  final id_sessao;
...
class _ComprasEntregue extends State<Pedidos_nao_Entregues> {
      ...
      setState(() {
        if (Basicos.offset < Basicos.meus_pedidos.length) {
          ...
          Navigator.of(context).push(new MaterialPageRoute(
            ...
            builder: (context) =>
                new Pedidos_nao_Entregues(id_sessao: widget.id_sessao),
          ));
        } else
                        ...
                        Expanded(
                          child: ClipRRect(
                            ...
                            child: Basicos.meus_pedidos.length == 0
                                ...
                                : ListView.builder(
                                    itemCount: Basicos.meus_pedidos.length,
                                    itemBuilder:
                                              ...
                                              children: <Widget>[
                                                ...
                                                new Row(
                                                  children: <Widget>[
                                                    ...
                                                    //                        Padding(
                                                    //                          padding: const EdgeInsets.only(left: 2, right: 5, bottom: 0, top: 6),
                                                    //                          //tanho das letra no lista de produtos
                                                    //                          child: new Text(
                                                    //                            Basicos.meus_pedidos[index].pedido_cliente,
  ...
  Future<List> listPedidos() async {
    String link = Basicos.codifica("${Basicos.ip}"
        "/crud/?crud=consult26.${'EM ANDAMENTO'},${widget.id_sessao},10,${Basicos.offset}");
    var res = await http
    ...
    String link2 = Basicos.codifica("${Basicos.ip}"
        "/crud/?crud=consult26.${'CONCLUIDO NAO ENTREGUE'},${widget.id_sessao},10,${Basicos.offset}");
    var res1 = await http
    ...
    if (res1.body.length > 2) {
      if (res1.statusCode == 200) {
        // converte a lista de consulta em uma lista dinamica
        List list = json.decode(res1.body).cast<Map<String, dynamic>>();
        print(list.length);
        //Meus_pedidos = list;
    ...
    String link3 = Basicos.codifica("${Basicos.ip}"
        "/crud/?crud=consult26.${'CANCELADO'},${widget.id_sessao},10,${Basicos.offset}");
    var res2 = await http
        .get(Uri.encodeFull(link3), headers: {"Accept": "application/json"});
    print(res2.statusCode);
    // var res = Basicos.decodifica(res2.body);
